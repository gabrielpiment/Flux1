...
useHead({
  title: 'Serviços Financeiros | Flux - Tecnologia Bancária',
  meta: [
    { name: 'description', content: 'Soluções de IA para o setor financeiro. Onboarding, cobrança e suporte com máxima segurança.' }
  ]
})
</script>

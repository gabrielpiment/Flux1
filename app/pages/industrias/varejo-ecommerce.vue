...
useHead({
  title: 'Varejo & E-commerce | Flux - Soluções para Vender Mais',
  meta: [
    { name: 'description', content: 'Escale seu e-commerce com a Flux. Recuperação de carrinho, rastreio e vendas assistidas por IA.' }
  ]
})
</script>

...
useHead({
  title: 'Flux AI | O Motor de Inteligência Enterprise',
  meta: [
    { name: 'description', content: 'Conheça o motor de IA que impulsiona a plataforma Flux. Performance, precisão e inteligência para seu negócio.' }
  ]
})
</script>

  ...
  <header id="site-header" :class="['header', { 'header-compact': isCompact }]">
    <nav class="nav">
      ...
      <div class="nav-links">
        ...
        <a href="https://chat.legendaryhub.com.br/login" target="_blank" rel="noopener" class="login-link">Entrar</a>
    ...
    <nav id="drawer" class="drawer" :class="{ 'is-open': isMobileMenuOpen }" :aria-hidden="!isMobileMenuOpen">
      <div class="drawer-content">
        ...
        <a href="https://chat.legendaryhub.com.br/login" target="_blank" rel="noopener" class="login-link"

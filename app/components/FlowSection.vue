    ...
    <div class="container flow-container">
      ...
      <div class="flow-viewer-wrapper">
        <div class="flow-viewer">
          <ClientOnly>
            <VueFlow v-model="elements" :default-edge-options="{ type: 'smoothstep', animated: true }"
              class="interactive-flow" :nodes-draggable="true" :nodes-connectable="false" :zoom-on-scroll="true">
              <Background pattern-color="#0072f5" :gap="20" :size="1" />
              <Controls />
              <MiniMap :mask-color="'rgba(10, 10, 10, 0.7)'" :node-color="'rgba(139, 92, 246, 0.4)'" />
                  ...
                  <div class="node-header">
                    <div class="node-wa-icon random-icon">
                      <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path d="M18 5L12 11l6 6M6 5l6 11-6 6" />
                      </svg>
                    </div>
                  ...
                  <div class="node-header">
                    <div class="node-wa-icon kanban-icon">
                      <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <path d="M7 7h2v10H7zm4 0h2v7h-2zm4 0h2v4h-2z" />
                      </svg>
                    </div>
                    <span>Quadro Kanban</span>
                  </div>
                  <div class="node-body">
                    <div class="kanban-field"><span>Quadro</span>
                      <div class="field-value">--</div>
                    </div>
                    <div class="kanban-field"><span>Coluna</span>
                      <div class="field-value">--</div>
                    </div>
                  </div>
                  <Handle type="target" :position="Position.Left" />
...
.flow-section {
  ...
  position: relative;
  overflow: hidden;
  background: radial-gradient(circle at 100% 50%, rgba(0, 114, 245, 0.05) 0%, transparent 60%);
}
...
.custom-node:hover {
  ...
  box-shadow: 0 0 20px rgba(0, 114, 245, 0.2);
}
